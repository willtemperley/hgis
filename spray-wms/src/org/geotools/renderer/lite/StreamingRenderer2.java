 ...
 * @version $Id$
 */
public class StreamingRenderer2 implements GTRenderer {
    ...
    private java.util.List<RenderListener> renderListeners = new CopyOnWriteArrayList<RenderListener>();
     ...
     */
    public StreamingRenderer2() {

    }

    //Fixme Hackery to get around irritation of masses of layers doing f all
    private ListFeatureCollection unsulliedFeatures;
    public void setFeatures(ListFeatureCollection features) {
        this.unsulliedFeatures = features;
    }
    ...
    public void paint(Graphics2D graphics, Rectangle paintArea,
        ...
        try {
            ...
            java.util.List<CompositingGroup> compositingGroups = CompositingGroup.splitOnCompositingBase(
            ...
            for (CompositingGroup compositingGroup : compositingGroups) {
                ...
                if(labelCache instanceof LabelCacheImpl) {
                    ((LabelCacheImpl) labelCache).setLabelRenderingMode(LabelCacheImpl.LabelRenderingMode.valueOf(getTextRenderingMethod()));
                }
    ...
    Query getStyleQuery(FeatureSource<FeatureType, Feature> source,
                        FeatureType schema, java.util.List<LiteFeatureTypeStyle> styleList,
        ...
        java.util.List<PropertyName> attributes;
        if (styles == null) {
            attributes = null;
        } else {
        ...
        try {
            ...
            java.util.List<ReferencedEnvelope> envelopes = null;
     ...
     * @return
     */
    private CoordinateReferenceSystem getNativeCRS(FeatureType schema, java.util.List<PropertyName> attNames) {
    ...
    private void processRuleForQuery(LiteFeatureTypeStyle[] styles, Query q) {
        try {
            ...
            final java.util.List<Filter> filtersToDS = new ArrayList<Filter>();
     ...
     *         <code>layer</code>
     */
    private java.util.List<PropertyName> findStyleAttributes(LiteFeatureTypeStyle[] styles,
                                                             FeatureType schema) {
         ...
         * behavior
         */
        java.util.List<PropertyName> atts = new ArrayList<PropertyName>(attributes);
     ...
     */
    private Filter createBBoxFilters(FeatureType schema, java.util.List<PropertyName> attributes,
                                     java.util.List<ReferencedEnvelope> bboxes) throws IllegalFilterException {
    ...
    private ArrayList<LiteFeatureTypeStyle> createLiteFeatureTypeStyles(
            java.util.List<FeatureTypeStyle> featureStyles,
        ...
        java.util.List<Rule> elseRuleList;
        LiteFeatureTypeStyle lfts;
        BufferedImage image;
     ...
     */
    private ArrayList<LiteFeatureTypeStyle> createLiteFeatureTypeStyles(
            java.util.List<FeatureTypeStyle> featureStyles, FeatureType ftype,
        ...
        for (FeatureTypeStyle fts : featureStyles) {
            if (isFeatureTypeStyleActive(ftype, fts)) {
                ...
                // get applicable rules at the current scale
                java.util.List[] splittedRules = splitRules(fts);
                java.util.List ruleList = splittedRules[0];
                java.util.List elseRuleList = splittedRules[1];
    ...
    boolean screenMapEnabled(LiteFeatureTypeStyle lfts) {
        ...
        OpacityFinder finder = new OpacityFinder(new Class[] { PointSymbolizer.class,
                org.opengis.style.LineSymbolizer.class, org.opengis.style.PolygonSymbolizer.class });
    ...
    private java.util.List[] splitRules(FeatureTypeStyle fts) {
        Rule[] rules;
        java.util.List<Rule> ruleList = new ArrayList<Rule>();
        java.util.List<Rule> elseRuleList = new ArrayList<Rule>();
        ...
        return new java.util.List[] {ruleList, elseRuleList};
    }
    ...
    private void processStylers(final Graphics2D graphics,
        ...
        if ( featureSource != null ) {
            ...
            java.util.List<java.util.List<LiteFeatureTypeStyle>> txClassified = classifyByTransformation(lfts);

            // render groups by uniform transformation
            for (java.util.List<LiteFeatureTypeStyle> uniform : txClassified) {
     ...
     */
    java.util.List<java.util.List<LiteFeatureTypeStyle>> classifyByTransformation(java.util.List<LiteFeatureTypeStyle> lfts) {
        java.util.List<java.util.List<LiteFeatureTypeStyle>> txClassified = new ArrayList<java.util.List<LiteFeatureTypeStyle>>();
        ...
        for (PropertyName attribute : query.getProperties()) {
            if(attribute.evaluate(schema) == null) {
                if (schema instanceof SimpleFeatureType) {
                    java.util.List<Name> allNames = new ArrayList<Name>();
    ...
    private void drawPlain(final Graphics2D graphics, MapLayer currLayer, AffineTransform at,
                           ...
                           final java.util.List<LiteFeatureTypeStyle> lfts) {
...
//                iterator = DataUtilities.iterator( featureIterator );
            ...
            try {
                ...
                // an infinite loop
//                FeatureIterator x = ((DecoratingFeatureCollection) features).features();
                SimpleFeatureIterator x = unsulliedFeatures.features();

                while (x.hasNext() && !renderingStopRequested) {
                    try {
                        rf.setFeature(x.next());
    ...
    private void drawOptimized(final Graphics2D graphics, MapLayer currLayer, AffineTransform at,
                               CoordinateReferenceSystem destinationCrs, String layerId, Collection collection,
                               FeatureCollection features, final NumberRange scaleRange, final java.util.List lfts) {
    ...
    private boolean isCloningRequired(MapLayer layer, LiteFeatureTypeStyle[] lfts) {
        ...
        final Set<RenderingHints.Key> hints = layer.getFeatureSource().getSupportedHints();
    ...
    private void processSymbolizers(final Graphics2D graphics,
                                    final RenderableFeature drawMe, final java.util.List<Symbolizer> symbolizers,
                                    NumberRange scaleRange, AffineTransform at,
                                    CoordinateReferenceSystem destinationCrs, String layerId)
            throws Exception {
        int paintCommands = 0;
    ...
    private class RenderableFeature {
        ...
        private java.util.List geometries = new ArrayList();
        ...
        public LiteShape2 getShape(Symbolizer symbolizer, AffineTransform at) throws FactoryException {
            ...
            try {
                ...
                if (screenMap != null //
                        ...
                        && !(g instanceof com.vividsolutions.jts.geom.Point)
