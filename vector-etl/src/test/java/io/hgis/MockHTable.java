 ...
 * <p>
 * Instances should be get using <code>io.hgis.MockHTable.create()</code>. So while a
 ...
 *   io.hgis.MockHTable table = io.hgis.MockHTable.create();
 ...
 * </pre>
 * <p>
 * io.hgis.MockHTable instances can also be initialized with pre-loaded data using one
 ...
 * <pre>
 * // String[][]
 * io.hgis.MockHTable table = io.hgis.MockHTable.with(new String[][] {
 *   { &quot;&lt;rowid&gt;&quot;, &quot;&lt;column&gt;&quot;, &quot;&lt;value&gt;&quot; },
 ...
 * io.hgis.MockHTable table = io.hgis.MockHTable.with((Map<String, Map<String, String>) new Yaml().load(database));
 * </pre>
 * <p>
 * If value is not supposed to be a String, but an int, double or anything,
 * <code>io.hgis.MockHTable.toEString()</code> can be used to turn it into a String.
 *
 * <p>
 * In order to simplify assertions for tests that should put anything into
 * database, io.hgis.MockHTable.read() works with two parameters (id and column) and
 ...
 * @author erdem
 *
 * Copied from https://gist.github.com/raw/613217/70df8a70dcac2fff1d239d43e8f52c43043d30bf/io.hgis.MockHTable.java.
 * See http://blog.erdemagaoglu.com/post/1254694314/unit-testing-hbase-applications.
 */
public class MockHTable implements HTableInterface {
  /**
   * This is all the data for a io.hgis.MockHTable instance
   */
  ...
  @Override
  public Boolean[] exists(List<Get> g) {
    return null;
  }
  ...
  /**
   * Default way of constructing a io.hgis.MockHTable
   * @return a new io.hgis.MockHTable
   */
  ...
  /**
   * Create a io.hgis.MockHTable with some pre-loaded data. Parameter should be a map of
   ...
   * @param dump
   *          pre-loaded data
   * @return a new io.hgis.MockHTable loaded with given data
   */
  ...
  /**
   * Create a io.hgis.MockHTable with some pre-loaded data. Parameter should be an array
